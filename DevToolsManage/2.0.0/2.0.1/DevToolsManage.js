...
(() => {
    ...
    // Disabled due to MZ update compatibility
...
class GameNwWindow {
        ...
        cleanup() {
            ...
            if (this._focusHandler) {
                currentWin.removeListener('focus', this._focusHandler);
                this._focusHandler = null;
            }
            if (this._blurHandler) {
                currentWin.removeListener('blur', this._blurHandler);
                this._blurHandler = null;
            }
            if (this._closeHandler) {
                currentWin.removeListener('close', this._closeHandler);
                this._closeHandler = null;
            }
